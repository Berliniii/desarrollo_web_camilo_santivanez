...
const poblarRegion = () => {
    ...
    // Recorre las regiones y añade las opciones correspondientes
    region_comuna.regiones.forEach(region => {
        const option = document.createElement("option");
        option.value = region.numero; // Usa el número de la región como valor
        option.textContent = region.nombre; // Usa el nombre de la región
...
const updateComunas = () => {
    ...
    if (region) {
        // Si la región tiene comunas, las agrega al select de comunas
